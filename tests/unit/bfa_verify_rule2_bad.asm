; tests/unit/bfa_verify_rule2_bad.asm
...
; -----------------------------------------------------------------------------
; verify.inc fixture: rule 2 (terminator): ret is not last -- trap follows it in the same block
; Parses the IR text below through parse.inc, runs bfa_verify_func, and
; checks the verdict is exactly BFA_VERIFY_R2_TERM (2).
;
