; tests/unit/bfa_verify_rule3_bad.asm
...
; -----------------------------------------------------------------------------
; verify.inc fixture: rule 3 (phi order): join's actual predecessor order is b1,b2 but the phi lists b2,b1
; Parses the IR text below through parse.inc, runs bfa_verify_func, and
; checks the verdict is exactly BFA_VERIFY_R3_PHI (3).
;
...
segment readable writeable
  ...
  outinst: dd 0
  srctext:
  db "functio @r3bad (u64 u64) -> u64 {", 10
  db "b0:", 10
  db "%0 = param u64 0", 10
  db "%1 = param u64 1", 10
