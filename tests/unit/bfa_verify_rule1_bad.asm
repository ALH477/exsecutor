; tests/unit/bfa_verify_rule1_bad.asm
...
; -----------------------------------------------------------------------------
; verify.inc fixture: rule 1 (operand type): %0 is u32 but add u64 requires u64 operands
; Parses the IR text below through parse.inc, runs bfa_verify_func, and
; checks the verdict is exactly BFA_VERIFY_R1_OPERAND (1).
;
