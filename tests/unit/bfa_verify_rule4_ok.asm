; tests/unit/bfa_verify_rule4_ok.asm
...
; -----------------------------------------------------------------------------
; verify.inc fixture: rule 4 (dominance): straight-line, every def dominates its use
...
segment readable writeable
  ...
  outinst: dd 0
  srctext:
  db "functio @r4ok (u64) -> u64 {", 10
  db "b0:", 10
  db "%0 = param u64 0", 10
  db "%1 = addw u64 %0 1", 10
  db "%2 = addw u64 %1 1", 10
  db "ret %2", 10
  db "}", 10
  .len = $ - srctext
