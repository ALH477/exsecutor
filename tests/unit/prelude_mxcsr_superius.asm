; tests/unit/prelude_mxcsr_superius.asm
...
; WHICH bit.
;
; THIS FIXTURE: EXS_MXCSR = 0x5F80 -- `rotundatio ad_superius`.
;
...
;   bits 13-14 RC 10   `rotundatio ad_superius` (toward +infinity)
...
assert ((EXS_MXCSR shr 13) and 3) = 2	; rotundatio ad_superius -- RC = 10, toward +inf
