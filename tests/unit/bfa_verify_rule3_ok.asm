; tests/unit/bfa_verify_rule3_ok.asm
...
; -----------------------------------------------------------------------------
; verify.inc fixture: rule 3 (phi order): join's phi lists b1 then b2, matching predvecs order
...
segment readable writeable
  ...
  outinst: dd 0
  srctext:
  db "functio @r3ok (u64 u64) -> u64 {", 10
  db "b0:", 10
  db "%0 = param u64 0", 10
  db "%1 = param u64 1", 10
