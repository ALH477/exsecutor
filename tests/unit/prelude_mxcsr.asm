...
; WHICH bit.
;
; THIS FIXTURE: EXS_MXCSR = 0x1F80 -- `rotundatio ad_parem` with
; `subnormales conservata`, which is spec 5.4's default and the image
; examples/initium.exsc compiles under.
;
...
;   bits 13-14 RC 00   `rotundatio ad_parem` (nearest-even)
...
assert ((EXS_MXCSR shr 13) and 3) = 0	; rotundatio ad_parem -- RC = 00, nearest-even
